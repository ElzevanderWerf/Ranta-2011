## Testing the logic-to-language translation system of Ranta (2011), for the English language
...
1. In `test3RandomGenerationGGC.py`, I wrote a Python script to randomly generate formulas in GGC notation, with a lexicon similar as the one in GGC. 1000 generated formulas are in `test3GGC.tmp`.
2. I ran TransTest.hs with arguments `test3GGC.tmp` and `test3Eng.tmp` (this took about 2 minutes):
